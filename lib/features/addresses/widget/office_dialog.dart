...
class OfficeDialog extends StatefulWidget {
  ...
  @override
  State<OfficeDialog> createState() => _OfficeDialogState();
}

class _OfficeDialogState extends State<OfficeDialog> {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Gap(15),
                  FormTitle(title: 'office_number'.tr()),
                  const Gap(10),
                  CustomField(
                    filled: true,
                    inputType: TextInputType.text,
                    hint: "enter_office_number".tr(),
